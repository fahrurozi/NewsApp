...
<div class="container-fluid px-4">
    ...
    <div class="row">
        ...
        @endif
        <form method="post" action="{{route('videos.update', $data_video->id)}}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" name="name" id="name" class="form-control" value="{{$data_video->name}}" placeholder="Masukan Judul Buku">
            </div>
            <div class="">
